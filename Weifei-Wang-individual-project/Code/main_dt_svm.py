...
class KaggleRF(QMainWindow):
    #::--------------------------------------------------------------------------------
    # Implementation of Decision Tree Classifier using the preprocessed dataset
    ...
    def initUi(self):
        ...
        self.scoretxt_rf = QLabel('Kaggle Score of Decision Tree:')
        self.scoretxt_rf.move(50, 20)


        self.png_rf = QPixmap('DT1.png')
...
class ResultsRF(QMainWindow):
    ...
    def __init__(self):
        ...
        self.Title = "Results of Decision Tree"
        self.initUi()
...
#::--------------------------------------------------------------------------------
    ...
    def __init__(self):
        ...
        self.Title = "ROC Curve of Decision Tree"
        self.initUi()
...
class PRcurveRF(QMainWindow):
    ...
    def __init__(self):
        ...
        self.Title = "P-R Curve of Decision Tree"
        self.initUi()
    ...
    def initUi(self):
        ...
        self.ax2.set_title('P-R Curve Decision Tree')
...
class KaggleNB(QMainWindow):
    #::--------------------------------------------------------------------------------
    # Implementation of Support Vector Machine Classifier using the preprocessed dataset
    # the methods in this class are
    #       _init_ : initialize the class
    #       initUi : creates the canvas and all the elements in the canvas
    #       update : populates the elements of the canvas
    ...
    def __init__(self):
        ...
        self.Title = "Kaggle Score of Support Vector Machine"
        self.initUi()
    ...
    def initUi(self):
        ...
        self.scoretxt_nb = QLabel('Kaggle Score of Support Vector Machine:')
        self.scoretxt_nb.move(50, 20)


        self.png_nb = QPixmap('SVM1.png')
...
class ResultsNB(QMainWindow):
    ...
    def __init__(self):
        ...
        self.Title = "Results of Support Vector Machine"
        self.initUi()
...
class ROCcurveNB(QMainWindow):
    ...
    def __init__(self):
        ...
        self.Title = "ROC Curve of Support Vector Machine"
        self.initUi()
    ...
    def initUi(self):
        ...
        self.ax3.set_title('ROC Curve Support Vector Machine')
...
class PRcurveNB(QMainWindow):
    ...
    def __init__(self):
        ...
        self.Title = "P-R Curve of Support Vector Machine"
        self.initUi()
    ...
    def initUi(self):
        ...
        self.ax4.set_title('P-R Support Vector Machine')
...
class App(QMainWindow):
    ...
    def initUI(self):
        ...
        RFMenu = mainMenu.addMenu('Decision Tree')
        NBMenu = mainMenu.addMenu('Support Vector Machine')
        ...
        #::------------------------------------------------------
        KaggleRFButton = QAction(QIcon(), 'Kaggle Score of Decision Tree', self)
        KaggleRFButton.setStatusTip('Kaggle Score of DT')
        ...
        # Decision Tree Classifier -- Results
        #::------------------------------------------------------
        ResultRFButton = QAction(QIcon(), 'Results of Decision Tree', self)
        ResultRFButton.setStatusTip('Results of DT')
        ResultRFButton.triggered.connect(self.RERF)

        RFMenu.addAction(ResultRFButton)
        #::------------------------------------------------------
        # DT Classifier -- ROC Curve
        #::------------------------------------------------------
        ROCRFButton = QAction(QIcon(), 'ROC Curve of Decision Tree', self)
        ROCRFButton.setStatusTip('ROC Curve of DT')
        ROCRFButton.triggered.connect(self.ROCRF)

        RFMenu.addAction(ROCRFButton)
        #::------------------------------------------------------
        # Decision Tree Classifier -- P-R Curve
        #::------------------------------------------------------
        PRRFButton = QAction(QIcon(), 'P-R Curve of Decision Tree', self)
        PRRFButton.setStatusTip('P-R Curve of DT')
        ...
        #::------------------------------------------------------
        KaggleNBButton = QAction(QIcon(), 'Kaggle Score of Support Vector Machine', self)
        KaggleNBButton.setStatusTip('Kaggle Score of SVM')
        ...
        #::--------------------------------------------------
        ResultNBButton =  QAction(QIcon(), 'Results of Support Vector Machine', self)
        ResultNBButton.setStatusTip('Results of SVM')
        ...
        #::------------------------------------------------------
        ROCNBButton = QAction(QIcon(), 'ROC Curve of Support Vector Machine', self)
        ROCNBButton.setStatusTip('ROC Curve of SVM')
        ROCNBButton.triggered.connect(self.ROCNB)

        NBMenu.addAction(ROCNBButton)
        #::------------------------------------------------------
        # Support Vector Machine -- P-R Curve
        #::------------------------------------------------------
        PRNBButton = QAction(QIcon(), 'P-R Curve of Support Vector Machine', self)
        PRNBButton.setStatusTip('P-R Curve of SVM')
    ...
    def KSRF(self):
        #::-------------------------------------------------------------
        # This function creates an instance of the Results of Decision Tree
        #::-------------------------------------------------------------
        dialog = KaggleRF()
    ...
    def ROCRF(self):
        #::-------------------------------------------------------------
        # This function creates an instance of the ROC Curve of Decision Tree
        #::-------------------------------------------------------------
        dialog = ROCcurveRF()
        self.dialogs.append(dialog)
        dialog.show()
    ...
    def PRRF(self):
        #::-------------------------------------------------------------
        # This function creates an instance of the P-R Curve of Decision Tree
        #::-------------------------------------------------------------
        dialog = PRcurveRF()
        self.dialogs.append(dialog)
        dialog.show()
    ...
    def RENB(self):
        #::-------------------------------------------------------------
        # This function creates an instance of the Results of SVM
        #::-------------------------------------------------------------
        dialog = ResultsNB()
        self.dialogs.append(dialog)
        dialog.show()
    ...
    def ROCNB(self):
        #::-------------------------------------------------------------
        # This function creates an instance of the ROC Curve of SVM
        #::-------------------------------------------------------------
        dialog = ROCcurveNB()
        self.dialogs.append(dialog)
        dialog.show()
    ...
    def PRNB(self):
        #::-------------------------------------------------------------
        # This function creates an instance of the P-R Curve of SVM
        #::-------------------------------------------------------------
        dialog = PRcurveNB()
        self.dialogs.append(dialog)
        dialog.show()
...
def real_or_not():
    ...
    ron_train = pd.read_csv('realornot_trainencode.csv')
    ron_test = pd.read_csv('realornot_testencode.csv')
    ...
    # Assign the X and y to run the Decision Tree Classifier
    ...
    clf_rf = DecisionTreeClassifier(n_estimators=1660, random_state=100)
